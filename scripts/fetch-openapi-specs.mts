      ...
      components: {
        ...
        schemas: {
                      ...
                      },
                      {
                        anyOf: [
                          ...
                          },
                          {
                            ...
                            description:
                              "Array of proxy configurations with routing",
                          },
                        ],
                      },
                    ],
          ...
          SessionPlayerResponse: {
            ...
            type: "string",
            description:
              "HTML content with rrweb player for the browser session",
          },
          ...
          SessionProxyResponse: {
              ...
              proxyStatus: {
                ...
                properties: {
                  ...
                  workingProxiesCount: {
                    type: "integer",
                    description:
                      "Number of working proxy alternatives available",
                  },
                  testingProgress: {
                    type: "object",
                    properties: {
                  ...
                  swapInProgress: {
                    type: "boolean",
                    description:
                      "Whether a proxy swap is currently in progress",
                  },
                },
                required: [
                  "currentProxy",
            ...
            additionalProperties: false,
            description:
              "Response containing proxy status information for a session",
          },
          ...
          KillJobResponse: {
            ...
            properties: {
              message: {
                type: "string",
                description:
                  "Success message confirming the job kill signal was sent",
              },
            },
            required: ["message"],
            additionalProperties: false,
      ...
      paths: {
        ...
        "/v1/sessions/{id}/debugger": {
          get: {
            ...
            tags: ["Sessions"],
            description:
              "Fetches the Chrome DevTools debugger URL of the specific session.",
            parameters: [
              {
                schema: {
                  type: "string",
        ...
        "/v1/sandbox/jobs": {
          post: {
            ...
            tags: ["Sandbox"],
            description:
              "Creates a new sandbox job with the provided configuration.",
            requestBody: {
              content: {
                "application/json": {
                  schema: {
        ...
        "/v1/sandbox/jobs/{jobId}/sessions": {
          get: {
            ...
            tags: ["Sandbox"],
            description:
              "Retrieves all sessions associated with a specific sandbox job.",
            parameters: [
              {
                schema: {
                  type: "string",
        ...
        "/v1/sandbox/jobs/{jobId}/kill": {
          post: {
            ...
            tags: ["Sandbox"],
            description:
              "Terminates a specific sandbox job and releases its resources.",
            requestBody: {
              content: {
                "application/json": {
                  schema: {
        ...
        "/v1/sandbox/public/jobs": {
          post: {
            ...
            tags: ["Sandbox"],
            description:
              "Creates a new public sandbox job without authentication.",
            requestBody: {
              content: {
                "application/json": {
                  schema: {
        ...
        "/v1/sandbox/public/jobs/{jobId}": {
          get: {
            ...
            tags: ["Sandbox"],
            description:
              "Retrieves details of a specific public sandbox job by ID.",
            parameters: [
              {
                schema: {
                  type: "string",
        ...
        "/v1/sandbox/public/jobs/{jobId}/sessions": {
          get: {
            ...
            tags: ["Sandbox"],
            description:
              "Retrieves all sessions associated with a specific public sandbox job.",
            parameters: [
              {
                schema: {
                  type: "string",
        ...
        "/v1/sandbox/public/jobs/{jobId}/kill": {
          post: {
            ...
            tags: ["Sandbox"],
            description:
              "Terminates a specific public sandbox job and releases its resources.",
            requestBody: {
              content: {
                "application/json": {
                  schema: {
        ...
        "/v1/secrets": {
          get: {
            ...
            tags: ["Secrets"],
            description:
              "Fetches all secret metadata for the current organization.",
            parameters: [
              {
                schema: {
                  type: "string",
        ...
        "/v1/feedback": {
          post: {
            ...
            summary:
              "Submit user feedback that will be sent to Discord webhook.",
            tags: ["Feedback"],
