...
async function generatePlatformApiSpec(): Promise<void> {
  try {
    ...
    const platformApiSpec = {
      openapi: "3.0.0",
      info: {
        title: "steel Platform API",
        version: "1.0.0",
        description:
          "API for managing devnets and chainhooks on the steel Platform",
      },
      servers: [
        {
          url: "https://api.platform.steel.so",
      ...
      paths: {
        ...
        "/v1/ext/{apiKey}/chainhooks": {
          get: {
            ...
            description:
              "Get all of your chainhooks through the steel Platform",
          ...
          post: {
            ...
            description: "Create a chainhook through the steel Platform",
        ...
        "/v1/ext/{apiKey}/chainhooks/{chainhookUuid}": {
          get: {
            ...
            description: "Get a specific chainhook through the steel Platform",
          ...
          put: {
            ...
            description: "Update a chainhook through the steel Platform",
          ...
          delete: {
            ...
            description: "Delete a chainhook through the steel Platform",
        ...
        "/v1/ext/{apiKey}/chainhooks/{chainhookUuid}/status": {
          get: {
            ...
            description:
              "Retrieve the status of a specific chainhook through the steel Platform",
