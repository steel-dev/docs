...
<RecipeMeta href="https://github.com/steel-dev/steel-cookbook/tree/3312a27bde50b050c163b3a379f6b7c4219834a3/examples/claude-computer-use-mobile" path="examples/claude-computer-use-mobile" authors={[{"handle":"jagadeshjai","name":"Jagadesh Jai","avatar":"https://github.com/jagadeshjai.png?size=40"}, {"handle":"junhsss","name":"Jun Ryu","avatar":"https://github.com/junhsss.png?size=40"}]} updated="2026-04-24" />
...
- **Persist a login.** Pass `sessionContext` into `sessions.create` to resume with cookies and local storage. Useful when the mobile site is gated behind auth. See [credentials](/cookbook/credentials).
