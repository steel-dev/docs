...
<RecipeJsonLd slug="you-com-search" title={"Combine You.com search with Steel browser actions"} description={"Pair the You.com Search and Contents APIs with a Steel cloud browser in a search-then-act LangChain agent that prefers the cheap path and only opens a session when interaction is required."} authors={[{"handle":"bsparker","name":"Brian Sparker"}]} datePublished="2026-04-30" dateModified="2026-04-30" sourceUrl="https://github.com/steel-dev/steel-cookbook/tree/406a3f60ccd2d1a2b6c1f07a1977fb9e4baae32c/examples/you-com-search" />

<RecipeMeta href="https://github.com/steel-dev/steel-cookbook/tree/406a3f60ccd2d1a2b6c1f07a1977fb9e4baae32c/examples/you-com-search" path="examples/you-com-search" authors={[{"handle":"bsparker","name":"Brian Sparker","avatar":"https://github.com/bsparker.png?size=40"}]} updated="2026-04-30" />

<RecipeQuickstart slug="you-com-search" />
