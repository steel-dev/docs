...
<RecipeJsonLd slug="chromiumoxide" title={"Automate a cloud browser with chromiumoxide"} description={"Use Steel with chromiumoxide to connect over CDP, drive the handler task, extract page content, and capture a screenshot."} authors={[{"handle":"junhsss","name":"Jun Ryu"}]} datePublished="2026-06-23" dateModified="2026-06-23" sourceUrl="https://github.com/steel-dev/steel-cookbook/tree/c506b2f6f7f97fa5bd47a616eac5315c9b9b1d25/examples/chromiumoxide" />

<RecipeMeta href="https://github.com/steel-dev/steel-cookbook/tree/c506b2f6f7f97fa5bd47a616eac5315c9b9b1d25/examples/chromiumoxide" path="examples/chromiumoxide" authors={[{"handle":"junhsss","name":"Jun Ryu","avatar":"https://github.com/junhsss.png?size=40"}]} updated="2026-06-23" />
