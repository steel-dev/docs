...
<RecipeJsonLd slug="chromiumoxide" title={"Automate a cloud browser with chromiumoxide"} description={"Use Steel with chromiumoxide to connect over CDP, drive the handler task, extract page content, and capture a screenshot."} authors={[{"handle":"junhsss","name":"Jun Ryu"}]} datePublished="2026-06-23" dateModified="2026-06-23" sourceUrl="https://github.com/steel-dev/steel-cookbook/tree/6bf72c7152ad4f37e283113f231eae56c1655f94/examples/chromiumoxide" />

<RecipeMeta href="https://github.com/steel-dev/steel-cookbook/tree/6bf72c7152ad4f37e283113f231eae56c1655f94/examples/chromiumoxide" path="examples/chromiumoxide" authors={[{"handle":"junhsss","name":"Jun Ryu","avatar":"https://github.com/junhsss.png?size=40"}]} updated="2026-06-23" />
