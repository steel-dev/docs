...
<RecipeMeta href="https://github.com/steel-dev/steel-cookbook/tree/rework/examples/claude-computer-use-ts" path="examples/claude-computer-use-ts" authors={[{"handle":"junhsss","name":"Jun Ryu","avatar":"https://github.com/junhsss.png?size=40"}]} updated="2026-04-24" />
...
<RecipeMeta href="https://github.com/steel-dev/steel-cookbook/tree/rework/examples/claude-computer-use-py" path="examples/claude-computer-use-py" authors={[{"handle":"hussufo","name":"Hussein Hussein","avatar":"https://github.com/hussufo.png?size=40"}, {"handle":"junhsss","name":"Jun Ryu","avatar":"https://github.com/junhsss.png?size=40"}]} updated="2026-04-24" />
