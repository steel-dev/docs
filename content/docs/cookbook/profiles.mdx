...
<RecipeMeta href="https://github.com/steel-dev/steel-cookbook/tree/rework/examples/profiles" path="examples/profiles" authors={[{"handle":"aspectrr","name":"Collin Pfeifer","avatar":"https://github.com/aspectrr.png?size=40"}, {"handle":"jagadeshjai","name":"Jagadesh Jai","avatar":"https://github.com/jagadeshjai.png?size=40"}]} updated="2026-04-24" />
