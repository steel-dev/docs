...
<RecipeJsonLd slug="headless-chrome" title={"Automate a cloud browser with headless_chrome"} description={"Use Steel with headless_chrome, the synchronous Rust equivalent of Puppeteer, to connect over CDP and scrape quotes with element handles, bridging the async Steel SDK through spawn_blocking."} authors={[{"handle":"junhsss","name":"Jun Ryu"}]} datePublished="2026-06-24" dateModified="2026-06-24" sourceUrl="https://github.com/steel-dev/steel-cookbook/tree/e4ddcfc994939ce89014c4bef94d40755e658899/examples/headless-chrome" />

<RecipeMeta href="https://github.com/steel-dev/steel-cookbook/tree/e4ddcfc994939ce89014c4bef94d40755e658899/examples/headless-chrome" path="examples/headless-chrome" authors={[{"handle":"junhsss","name":"Jun Ryu","avatar":"https://github.com/junhsss.png?size=40"}]} updated="2026-06-24" />

<RecipeQuickstart slug="headless-chrome" />
