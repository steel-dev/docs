...
<RecipeJsonLd slug="files" title={"Move files between your machine and a cloud browser"} description={"Use the Steel Files API with Playwright to automate file uploads and downloads in the cloud."} authors={[{"handle":"junhsss","name":"Jun Ryu"}]} datePublished="2024-11-19" dateModified="2026-04-24" sourceUrl="https://github.com/steel-dev/steel-cookbook/tree/fba13c52cfec7c57202d987c33d9a078538f108b/examples/files-api" />

<RecipeMeta href="https://github.com/steel-dev/steel-cookbook/tree/fba13c52cfec7c57202d987c33d9a078538f108b/examples/files-api" path="examples/files-api" authors={[{"handle":"junhsss","name":"Jun Ryu","avatar":"https://github.com/junhsss.png?size=40"}]} updated="2026-04-24" />
