...
<RecipeMeta href="https://github.com/steel-dev/steel-cookbook/tree/rework/examples/gemini-computer-use-ts" path="examples/gemini-computer-use-ts" authors={[{"handle":"junhsss","name":"Jun Ryu","avatar":"https://github.com/junhsss.png?size=40"}]} updated="2026-04-24" />
...
<RecipeMeta href="https://github.com/steel-dev/steel-cookbook/tree/rework/examples/gemini-computer-use-py" path="examples/gemini-computer-use-py" authors={[{"handle":"junhsss","name":"Jun Ryu","avatar":"https://github.com/junhsss.png?size=40"}]} updated="2026-04-24" />
