...
<RecipeJsonLd slug="gemini-computer-use" title={"Drive a browser with Gemini Computer Use"} description={"Connect Google's Gemini Computer Use to a Steel browser session for autonomous web interactions."} authors={[{"handle":"junhsss","name":"Jun Ryu"}]} datePublished="2025-11-25" dateModified="2026-04-24" sourceUrl="https://github.com/steel-dev/steel-cookbook/tree/282aab34ac443c363254074e5f501a616831c943/examples/gemini-computer-use-ts" />
...
<RecipeMeta href="https://github.com/steel-dev/steel-cookbook/tree/282aab34ac443c363254074e5f501a616831c943/examples/gemini-computer-use-ts" path="examples/gemini-computer-use-ts" authors={[{"handle":"junhsss","name":"Jun Ryu","avatar":"https://github.com/junhsss.png?size=40"}]} updated="2026-04-24" />
...
<RecipeMeta href="https://github.com/steel-dev/steel-cookbook/tree/282aab34ac443c363254074e5f501a616831c943/examples/gemini-computer-use-py" path="examples/gemini-computer-use-py" authors={[{"handle":"junhsss","name":"Jun Ryu","avatar":"https://github.com/junhsss.png?size=40"}]} updated="2026-04-24" />
