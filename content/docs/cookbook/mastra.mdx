...
<RecipeJsonLd slug="mastra" title={"Build a typed browser agent with Mastra"} description={"Use Steel with Mastra to build a typed browser agent with the Mastra Model Router and Studio playground."} authors={[{"handle":"junhsss","name":"Jun Ryu"}]} datePublished="2026-04-29" dateModified="2026-04-29" sourceUrl="https://github.com/steel-dev/steel-cookbook/tree/28647fff2631ecaf6e17124e62b0b6c957ea5509/examples/mastra" />

<RecipeMeta href="https://github.com/steel-dev/steel-cookbook/tree/28647fff2631ecaf6e17124e62b0b6c957ea5509/examples/mastra" path="examples/mastra" authors={[{"handle":"junhsss","name":"Jun Ryu","avatar":"https://github.com/junhsss.png?size=40"}]} updated="2026-04-29" />
