...
<RecipeJsonLd slug="mastra" title={"Build a typed browser agent with Mastra"} description={"Use Steel with Mastra to build a typed browser agent with the Mastra Model Router and Studio playground."} authors={[{"handle":"junhsss","name":"Jun Ryu"}]} datePublished="2026-04-29" dateModified="2026-04-29" sourceUrl="https://github.com/steel-dev/steel-cookbook/tree/406a3f60ccd2d1a2b6c1f07a1977fb9e4baae32c/examples/mastra" />

<RecipeMeta href="https://github.com/steel-dev/steel-cookbook/tree/406a3f60ccd2d1a2b6c1f07a1977fb9e4baae32c/examples/mastra" path="examples/mastra" authors={[{"handle":"junhsss","name":"Jun Ryu","avatar":"https://github.com/junhsss.png?size=40"}]} updated="2026-04-29" />
