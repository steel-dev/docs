...
<RecipeJsonLd slug="vercel-ai-sdk-nextjs" title={"Stream a browser agent into a Next.js chat app"} description={"A Next.js App Router chat app where a Vercel AI SDK agent drives a Steel cloud browser with embedded Live View."} authors={[{"handle":"junhsss","name":"Jun Ryu"}]} datePublished="2026-04-23" dateModified="2026-04-24" sourceUrl="https://github.com/steel-dev/steel-cookbook/tree/282aab34ac443c363254074e5f501a616831c943/examples/vercel-ai-sdk-nextjs" />

<RecipeMeta href="https://github.com/steel-dev/steel-cookbook/tree/282aab34ac443c363254074e5f501a616831c943/examples/vercel-ai-sdk-nextjs" path="examples/vercel-ai-sdk-nextjs" authors={[{"handle":"junhsss","name":"Jun Ryu","avatar":"https://github.com/junhsss.png?size=40"}]} updated="2026-04-24" />
