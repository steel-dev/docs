...
<RecipeMeta href="https://github.com/steel-dev/steel-cookbook/tree/f658197a4da35d8607960852ecbb88caebfd2c79/examples/pydantic-ai" path="examples/pydantic-ai" authors={[{"handle":"junhsss","name":"Jun Ryu","avatar":"https://github.com/junhsss.png?size=40"}]} updated="2026-04-29" />
...
[Steel + OpenAI Agents SDK (Python)](/cookbook/openai-agents) for a sibling typed-agent recipe with handoffs and tracing. [Pydantic AI documentation](https://ai.pydantic.dev/) for tools, output validators, retries, and Logfire integration.
