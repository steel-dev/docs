...
<RecipeJsonLd slug="pydantic-ai" title={"Build a typed browser agent with Pydantic AI"} description={"Use Steel with Pydantic AI to build typed, provider-agnostic browser agents with dependency injection."} authors={[{"handle":"junhsss","name":"Jun Ryu"}]} datePublished="2026-04-29" dateModified="2026-04-29" sourceUrl="https://github.com/steel-dev/steel-cookbook/tree/28647fff2631ecaf6e17124e62b0b6c957ea5509/examples/pydantic-ai" />

<RecipeMeta href="https://github.com/steel-dev/steel-cookbook/tree/28647fff2631ecaf6e17124e62b0b6c957ea5509/examples/pydantic-ai" path="examples/pydantic-ai" authors={[{"handle":"junhsss","name":"Jun Ryu","avatar":"https://github.com/junhsss.png?size=40"}]} updated="2026-04-29" />
