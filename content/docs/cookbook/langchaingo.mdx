...
<RecipeJsonLd slug="langchaingo" title={"Build a browser agent with LangChainGo"} description={"Use Steel with LangChainGo's zero-shot ReAct (MRKL) agent and a string-in, string-out scrape tool so Claude reads a page and answers a question."} authors={[{"handle":"junhsss","name":"Jun Ryu"}]} datePublished="2026-06-23" dateModified="2026-06-23" sourceUrl="https://github.com/steel-dev/steel-cookbook/tree/e4ddcfc994939ce89014c4bef94d40755e658899/examples/langchaingo" />

<RecipeMeta href="https://github.com/steel-dev/steel-cookbook/tree/e4ddcfc994939ce89014c4bef94d40755e658899/examples/langchaingo" path="examples/langchaingo" authors={[{"handle":"junhsss","name":"Jun Ryu","avatar":"https://github.com/junhsss.png?size=40"}]} updated="2026-06-23" />
