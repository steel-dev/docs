...
<RecipeJsonLd slug="convex-chat-with-page" title={"Chat with any webpage on Convex"} description={"Convex app that streams an AI agent's answer about any URL. The agent runs server-side with one Steel-backed scrape tool and pages through long articles via a chunked cache."} authors={[{"handle":"nibzard","name":"Nikola Balic"}]} datePublished="2026-05-04" dateModified="2026-05-04" sourceUrl="https://github.com/steel-dev/steel-cookbook/tree/6bf72c7152ad4f37e283113f231eae56c1655f94/examples/convex-chat-with-page" />

<RecipeMeta href="https://github.com/steel-dev/steel-cookbook/tree/6bf72c7152ad4f37e283113f231eae56c1655f94/examples/convex-chat-with-page" path="examples/convex-chat-with-page" authors={[{"handle":"nibzard","name":"Nikola Balic","avatar":"https://github.com/nibzard.png?size=40"}]} updated="2026-05-04" />
