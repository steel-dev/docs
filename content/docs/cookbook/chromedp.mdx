...
<RecipeJsonLd slug="chromedp" title={"Automate a cloud browser with chromedp"} description={"Use Steel with chromedp to connect over CDP, navigate to Hacker News, extract the top stories, and capture a screenshot."} authors={[{"handle":"junhsss","name":"Jun Ryu"}]} datePublished="2026-06-23" dateModified="2026-06-23" sourceUrl="https://github.com/steel-dev/steel-cookbook/tree/6bf72c7152ad4f37e283113f231eae56c1655f94/examples/chromedp" />

<RecipeMeta href="https://github.com/steel-dev/steel-cookbook/tree/6bf72c7152ad4f37e283113f231eae56c1655f94/examples/chromedp" path="examples/chromedp" authors={[{"handle":"junhsss","name":"Jun Ryu","avatar":"https://github.com/junhsss.png?size=40"}]} updated="2026-06-23" />
