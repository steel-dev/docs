...
<RecipeJsonLd slug="langgraph" title={"Build a typed browser agent with LangGraph"} description={"Use Steel with LangGraph to build a typed browser agent with an explicit state-machine loop and a structured-output formatter node."} authors={[{"handle":"junhsss","name":"Jun Ryu"}]} datePublished="2026-04-29" dateModified="2026-04-29" sourceUrl="https://github.com/steel-dev/steel-cookbook/tree/282aab34ac443c363254074e5f501a616831c943/examples/langgraph" />

<RecipeMeta href="https://github.com/steel-dev/steel-cookbook/tree/282aab34ac443c363254074e5f501a616831c943/examples/langgraph" path="examples/langgraph" authors={[{"handle":"junhsss","name":"Jun Ryu","avatar":"https://github.com/junhsss.png?size=40"}]} updated="2026-04-29" />
