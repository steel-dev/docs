...
<RecipeMeta href="https://github.com/steel-dev/steel-cookbook/tree/f658197a4da35d8607960852ecbb88caebfd2c79/examples/langgraph" path="examples/langgraph" authors={[{"handle":"junhsss","name":"Jun Ryu","avatar":"https://github.com/junhsss.png?size=40"}]} updated="2026-04-29" />
...
[OpenAI Agents SDK (Python)](/cookbook/openai-agents) for the framework-managed tool loop. [Browser Use](/cookbook/browser-use) for a higher-level agent. [LangGraph docs](https://langchain-ai.github.io/langgraph/).
