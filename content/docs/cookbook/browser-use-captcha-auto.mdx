...
<RecipeMeta href="https://github.com/steel-dev/steel-cookbook/tree/c601e6203a2ea6a009d55f09e5435a1e08b85190/examples/browser-use-captcha-auto" path="examples/browser-use-captcha-auto" authors={[{"handle":"jagadeshjai","name":"Jagadesh Jai","avatar":"https://github.com/jagadeshjai.png?size=40"}]} updated="2026-04-24" />
