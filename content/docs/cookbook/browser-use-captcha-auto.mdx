...
<RecipeJsonLd slug="browser-use-captcha-auto" title={"Solve CAPTCHAs automatically in a Browser Use agent"} description={"Build an AI agent with browser-use and Steel that solves CAPTCHAs automatically."} authors={[{"handle":"jagadeshjai","name":"Jagadesh Jai"}]} datePublished="2025-02-20" dateModified="2026-04-24" sourceUrl="https://github.com/steel-dev/steel-cookbook/tree/28647fff2631ecaf6e17124e62b0b6c957ea5509/examples/browser-use-captcha-auto" />

<RecipeMeta href="https://github.com/steel-dev/steel-cookbook/tree/28647fff2631ecaf6e17124e62b0b6c957ea5509/examples/browser-use-captcha-auto" path="examples/browser-use-captcha-auto" authors={[{"handle":"jagadeshjai","name":"Jagadesh Jai","avatar":"https://github.com/jagadeshjai.png?size=40"}]} updated="2026-04-24" />
