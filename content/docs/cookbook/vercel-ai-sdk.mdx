...
<RecipeJsonLd slug="vercel-ai-sdk" title={"Build a typed browser agent with the Vercel AI SDK"} description={"Use Steel with the Vercel AI SDK v6 ToolLoopAgent for typed, tool-using browser agents."} authors={[{"handle":"junhsss","name":"Jun Ryu"}]} datePublished="2026-04-23" dateModified="2026-04-24" sourceUrl="https://github.com/steel-dev/steel-cookbook/tree/b9235a859ef0ff94fccc4b443b10b7341f16209e/examples/vercel-ai-sdk-ts" />

<RecipeMeta href="https://github.com/steel-dev/steel-cookbook/tree/b9235a859ef0ff94fccc4b443b10b7341f16209e/examples/vercel-ai-sdk-ts" path="examples/vercel-ai-sdk-ts" authors={[{"handle":"junhsss","name":"Jun Ryu","avatar":"https://github.com/junhsss.png?size=40"}]} updated="2026-04-24" />
