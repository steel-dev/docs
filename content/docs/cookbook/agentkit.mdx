...
<RecipeMeta href="https://github.com/steel-dev/steel-cookbook/tree/rework/examples/agentkit" path="examples/agentkit" authors={[{"handle":"junhsss","name":"Jun Ryu","avatar":"https://github.com/junhsss.png?size=40"}]} updated="2026-04-24" />
