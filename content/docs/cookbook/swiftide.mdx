...
<RecipeJsonLd slug="swiftide" title={"Build a research agent with Swiftide"} description={"Use Steel with Swiftide to build an agent whose tool reads the web through Steel's scrape endpoint, so the model works from clean Markdown with no browser library."} authors={[{"handle":"junhsss","name":"Jun Ryu"}]} datePublished="2026-06-23" dateModified="2026-06-23" sourceUrl="https://github.com/steel-dev/steel-cookbook/tree/e4ddcfc994939ce89014c4bef94d40755e658899/examples/swiftide" />

<RecipeMeta href="https://github.com/steel-dev/steel-cookbook/tree/e4ddcfc994939ce89014c4bef94d40755e658899/examples/swiftide" path="examples/swiftide" authors={[{"handle":"junhsss","name":"Jun Ryu","avatar":"https://github.com/junhsss.png?size=40"}]} updated="2026-06-23" />
