...
<RecipeJsonLd slug="eino" title={"Build a browser agent with Eino"} description={"Use Steel with the ByteDance Eino framework to build a ReAct agent that calls Steel's scrape API as a tool to research and answer a web question."} authors={[{"handle":"junhsss","name":"Jun Ryu"}]} datePublished="2026-06-23" dateModified="2026-06-23" sourceUrl="https://github.com/steel-dev/steel-cookbook/tree/e08de0575649d82b60ddfad343541f336589d919/examples/eino" />

<RecipeMeta href="https://github.com/steel-dev/steel-cookbook/tree/e08de0575649d82b60ddfad343541f336589d919/examples/eino" path="examples/eino" authors={[{"handle":"junhsss","name":"Jun Ryu","avatar":"https://github.com/junhsss.png?size=40"}]} updated="2026-06-23" />
