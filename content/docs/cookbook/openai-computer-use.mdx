...
<RecipeJsonLd slug="openai-computer-use" title={"Drive a browser with OpenAI Computer Use"} description={"Connect OpenAI's Computer Use Assistant to a Steel browser session for autonomous web interactions."} authors={[{"handle":"junhsss","name":"Jun Ryu"}, {"handle":"nibzard","name":"Nikola Balic"}]} datePublished="2025-03-19" dateModified="2026-04-24" sourceUrl="https://github.com/steel-dev/steel-cookbook/tree/230b0586a5d5653cdf623c5dc437f54426192e57/examples/openai-computer-use-ts" />
