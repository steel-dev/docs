...
<RecipeJsonLd slug="openai-computer-use" title={"Drive a browser with OpenAI Computer Use"} description={"Connect OpenAI's Computer Use Assistant to a Steel browser session for autonomous web interactions."} authors={[{"handle":"junhsss","name":"Jun Ryu"}, {"handle":"nibzard","name":"Nikola Balic"}]} datePublished="2025-03-19" dateModified="2026-04-24" sourceUrl="https://github.com/steel-dev/steel-cookbook/tree/fba13c52cfec7c57202d987c33d9a078538f108b/examples/openai-computer-use-ts" />
