...
<RecipeJsonLd slug="notte" title={"Control a browser with Notte's reasoning engine"} description={"Control browsers with AI using Steel's infrastructure and Notte's reasoning engine."} authors={[{"handle":"junhsss","name":"Jun Ryu"}]} datePublished="2025-08-26" dateModified="2026-04-24" sourceUrl="https://github.com/steel-dev/steel-cookbook/tree/3d4db4fa997d1895d84d9d8106eaf25d97a60192/examples/notte" />

<RecipeMeta href="https://github.com/steel-dev/steel-cookbook/tree/3d4db4fa997d1895d84d9d8106eaf25d97a60192/examples/notte" path="examples/notte" authors={[{"handle":"junhsss","name":"Jun Ryu","avatar":"https://github.com/junhsss.png?size=40"}]} updated="2026-04-24" />
