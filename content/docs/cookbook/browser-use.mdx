...
<RecipeJsonLd slug="browser-use" title={"Build a browser agent with Browser Use"} description={"Integrate Steel with the browser-use framework for AI-driven web automation."} authors={[{"handle":"junhsss","name":"Jun Ryu"}]} datePublished="2025-02-20" dateModified="2026-04-24" sourceUrl="https://github.com/steel-dev/steel-cookbook/tree/230b0586a5d5653cdf623c5dc437f54426192e57/examples/browser-use" />

<RecipeMeta href="https://github.com/steel-dev/steel-cookbook/tree/230b0586a5d5653cdf623c5dc437f54426192e57/examples/browser-use" path="examples/browser-use" authors={[{"handle":"junhsss","name":"Jun Ryu","avatar":"https://github.com/junhsss.png?size=40"}]} updated="2026-04-24" />
