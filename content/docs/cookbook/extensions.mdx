...
<RecipeMeta href="https://github.com/steel-dev/steel-cookbook/tree/rework/examples/extensions" path="examples/extensions" authors={[{"handle":"aspectrr","name":"Collin Pfeifer","avatar":"https://github.com/aspectrr.png?size=40"}, {"handle":"junhsss","name":"Jun Ryu","avatar":"https://github.com/junhsss.png?size=40"}]} updated="2026-04-24" />
...
[Credentials](/cookbook/credentials) for persisting cookies across runs, [auth-context](/cookbook/auth-context) for seeding logged-in state, [profiles](/cookbook/profiles) for reusing a full browser profile. [Playwright docs](https://playwright.dev).
