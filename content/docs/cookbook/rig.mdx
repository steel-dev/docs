...
<RecipeJsonLd slug="rig" title={"Build a browser agent with rig"} description={"Use Steel with rig to build an agent that drives a cloud browser over CDP with chromiumoxide through navigate and extract tools, then answers a multi-step web task."} authors={[{"handle":"junhsss","name":"Jun Ryu"}]} datePublished="2026-06-23" dateModified="2026-06-23" sourceUrl="https://github.com/steel-dev/steel-cookbook/tree/e4ddcfc994939ce89014c4bef94d40755e658899/examples/rig" />

<RecipeMeta href="https://github.com/steel-dev/steel-cookbook/tree/e4ddcfc994939ce89014c4bef94d40755e658899/examples/rig" path="examples/rig" authors={[{"handle":"junhsss","name":"Jun Ryu","avatar":"https://github.com/junhsss.png?size=40"}]} updated="2026-06-23" />
