...
<RecipeJsonLd slug="crewai" title={"Build a multi-agent browser workflow with CrewAI"} description={"Integrate Steel with the CrewAI multi-agent framework."} authors={[{"handle":"junhsss","name":"Jun Ryu"}]} datePublished="2025-09-05" dateModified="2026-04-24" sourceUrl="https://github.com/steel-dev/steel-cookbook/tree/230b0586a5d5653cdf623c5dc437f54426192e57/examples/crewai" />

<RecipeMeta href="https://github.com/steel-dev/steel-cookbook/tree/230b0586a5d5653cdf623c5dc437f54426192e57/examples/crewai" path="examples/crewai" authors={[{"handle":"junhsss","name":"Jun Ryu","avatar":"https://github.com/junhsss.png?size=40"}]} updated="2026-04-24" />
