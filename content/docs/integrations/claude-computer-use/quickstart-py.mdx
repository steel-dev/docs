...
How to use Claude Computer Use with Steel
 ...
 [![link icon](https://api.scalar.com/cdn/images/jBw8j7D0nDuWr2AD2vuO5/fPY1vc0gHOyKJLz6lRIZ8.png) Try in Playground](https://playground.steel.dev/?template=steel-claude-computer-use-python-starter)
...
TASK = "Go to https://docs.anthropic.com, find information about Claude's capabilities, and provide a summary."b
```
