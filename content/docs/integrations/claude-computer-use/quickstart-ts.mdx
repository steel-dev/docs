...
# Quickstart (TS/Node) | Overview
How to use Claude Computer Use with Steel

 [![link icon](https://api.scalar.com/cdn/images/jBw8j7D0nDuWr2AD2vuO5/AhPJW6M5H7BlYpJVxYdOS.png) Try in Playground](https://playground.steel.dev/?template=steel-claude-computer-use-node-starter)
