...
This guide walks you through wiring a **CrewAI** multi-agent workflow to Steel so your agents can research the web and produce a structured report.
 ...
 [![link icon](https://api.scalar.com/cdn/images/jBw8j7D0nDuWr2AD2vuO5/fPY1vc0gHOyKJLz6lRIZ8.png) Try in Playground](https://playground.steel.dev/?template=steel-crew-ai-starter)
