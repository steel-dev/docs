...
How to use OpenAI Computer Use with Steel
 ...
 [![link icon](https://api.scalar.com/cdn/images/jBw8j7D0nDuWr2AD2vuO5/Nl99W43hHYGJt3pZtf6Mg.png) Try in Playground](https://playground.steel.dev/?template=steel-oai-computer-use-python-starter)
