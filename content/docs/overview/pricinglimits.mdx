...
:::callout
type: warn
### CAPTCHA solving and proxies need a $10 deposit on Launch
Launch plan requires $10 in paid balance to unlock CAPTCHA solving and Steel-provided proxies.
Free credits do not count. That balance goes toward usage, not an extra fee. Scale includes
anti-bot; Enterprise is custom.
:::
