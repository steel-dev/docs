...
| Rates | Browser tools (`/scrape`) | $5/1k | $5/1k | Custom |
...
| Limits | Data retention | 7 days | 30 days | Custom |
...
Browser Tools usage for `/scrape` is $5 per 1,000 calls on Launch and Scale, with custom
Enterprise pricing.
