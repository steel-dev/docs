...
description: Run browser automation from the terminal with the Steel CLI. Manage sessions, scrape, screenshot, and ship a Skill package for coding agents like Claude Code, Codex, and OpenCode.
llm: true
---
