...
You can also clone it on [Github](https://github.com/steel-dev/steel-cookbook/tree/main/examples/playwright-py) or [Replit](https://replit.com/@steel-dev/steel-playwright-python-starter?v=1) to start editing it yourself!
