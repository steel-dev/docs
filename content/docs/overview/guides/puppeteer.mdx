...
You can also clone it on [Github](https://github.com/steel-dev/steel-cookbook/tree/main/examples/puppeteer-ts), [StackBlitz](https://stackblitz.com/edit/steel-puppeteer-starter?file=README.md), or [Replit](https://replit.com/@steel-dev/steel-puppeteer-starter?v=1) to start editing it yourself!
