...
Build AI agents that navigate the web using natural language instructions
 ...
 [![link icon](https://api.scalar.com/cdn/images/jBw8j7D0nDuWr2AD2vuO5/PnzqIS1f2zIX0J57B8nz4.png) Try in Playground](https://playground.steel.dev/?template=steel-stagehand-node-starter)
