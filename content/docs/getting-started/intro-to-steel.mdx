...
![](https://api.scalar.com/cdn/images/jBw8j7D0nDuWr2AD2vuO5/D-Yt182xdIQAAQph6XjuT.png)
...
:::next-steps
- [Overview](/overview): Overview of the Sessions API
- [Quickstart](/sessions-api/quickstart): Quickstart guide for the Sessions API
:::

- Connect with Puppeteer(/examples/puppeteer)

- Drive a Steel session with Puppeteer via WebSocket connection

- Connect with Playwright(/examples/playwright)

- Drive a Steel session with Playwright via WebSocket connection

- Connect with Selenium(/examples/selenium)

- How to drive and connect to Steel browser sessions with Selenium(/examples/selenium)
### Reference
:::next-steps
- [Python SDK Reference](/python-sdk-reference): Python SDK Reference
- [Node SDK Reference](/node-sdk-reference): Node SDK Reference
:::
