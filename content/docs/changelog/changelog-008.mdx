...
<Image src="/images/oWlREKD5nejyDprfYbiGM.png" alt="Changelog 8" width={800} height={400} />
...
[Documentation Link](https://docs.steel.dev/overview/sessions-api/reusing-auth-context) | [Auth Examples](https://github.com/steel-dev/steel-cookbook/tree/main/examples/auth-context)
