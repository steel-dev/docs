---
title: "Steel CAPTCHAs API, Onboarding, and Bug Fixes"
sidebarTitle: "Steel CAPTCHAs API & Fixes"
llm: false
---

![](https://api.scalar.com/cdn/images/jBw8j7D0nDuWr2AD2vuO5/1qPnwADZHqUbfaVWwOTmc.png)
