...
[Cookbook Example (TS)](https://github.com/steel-dev/steel-cookbook/tree/main/examples/openai-computer-use-ts) | [Cookbook Example (Python)](https://github.com/steel-dev/steel-cookbook/tree/main/examples/openai-computer-use-py) | [Docs](https://docs.steel.dev/integrations/openai-computer-use)
