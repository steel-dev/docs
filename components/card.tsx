      ...
      >
        ...
        <div className="flex flex-wrap gap-2 mt-4">
          {tags?.map((tag) => (
            <div
              key={tag}
              className="px-2.5 dark:bg-yellow-50/5 bg-yellow-50 rounded-full inline-flex justify-start items-center uppercase text-stone-400 text-xs font-mono transition-colors !py-0 h-fit"
            >
              {tag}
            </div>
          ))}
        ...
        <div className="flex flex-col w-full">
          ...
          <div className="flex flex-wrap gap-2 mt-4">
            {tags?.map((tag) => (
              <div
                key={tag}
                className="px-2.5 bg-yellow-50/5 rounded-full inline-flex justify-start items-center uppercase text-stone-400 text-xs font-mono transition-colors !py-0 h-fit"
              >
                {tag}
              </div>
            ))}
