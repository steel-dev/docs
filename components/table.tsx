        ...
        <TableHeader>
          <TableRow className="border-0 border-b border-border">
            {headers.map((header, i) => (
              <TableHead
                key={i}
                className="text-left text-base font-normal text-foreground font-mono h-auto px-4 py-3 bg-background border-0 border-b border-border/50 [&_code]:whitespace-nowrap"
              >
                {header}
              </TableHead>
            ))}
