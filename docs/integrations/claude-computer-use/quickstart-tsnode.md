...
const TASK =
  "Go to https://arxiv.org, search for 'machine learning', and summarize the latest papers.";

// E-commerce tasks
const TASK =
  "Go to https://www.amazon.com, search for 'wireless headphones', and compare the top 3 results.";

// Information gathering
const TASK =
  "Go to https://docs.anthropic.com, find information about Claude's capabilities, and provide a summary.";
```
